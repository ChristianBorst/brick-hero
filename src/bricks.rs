...
pub fn spawn_bricks(commands: &mut Commands, level: usize) -> usize {
    ...
    for row in 0..brick_rows {
        ...
        num_bricks += spawn_brick_row(commands, row_strength, row_y, left_edge, brick_cols);
    }
    num_bricks
}
...
pub fn spawn_brick_row(
    ...
    for col in 0..cols {
        ...
        commands.spawn((
            brick_sprite(brick_pos, brick.clone()),
            brick,
            Collider,
...
fn brick_sprite(position: Vec2, brick: Brick) -> SpriteBundle {
